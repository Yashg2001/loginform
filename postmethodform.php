...
<script type="text/javascript">
	function validation()
	{
		...
		if(rollno == "")
		{
			document.getElementById('rolll').innerHTML="**Please write your rollno";
			return false;
		}
...
$query="INSERT INTO student VALUES ($rn,'$fn','$ln',$mo,'$em','$pa','$co','$ge','$dob','$laknstr','$ad')";
